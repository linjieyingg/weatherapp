...
urlpatterns = [
    ...
    path("update_bis/<int:pk>", views.ObservationUpdatebisView.as_view(), name="observation_update_bis"),
    path("update/<int:pk>", views.WeatherUpdateView.as_view(), name="weather_update"),
